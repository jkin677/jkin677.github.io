...
/**
 * @fileoverview tests goog.async.run using its goog.async.nextTick codepath
 * activated via goog.testing.MockClock.
 */

goog.provide('goog.async.runNextTickTest');
...
goog.setTestOnly('goog.async.runNextTickTest');
