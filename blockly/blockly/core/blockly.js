...
/**
Does the clipboard contain a multiprocessing block?
*/
Blockly.ParallelBlockInClipboard = false;
    ...
    if (e.keyCode == 86) {
      ...
      if (Blockly.clipboardXml_) {
        ...
        if (Blockly.clipboardTypeCounts_ &&
            workspace.isCapacityAvailable(Blockly.clipboardTypeCounts_) && !Blockly.ParallelBlockInClipboard) {
...
Blockly.copy_ = function(toCopy) {
  if (toCopy.type == 'multiprocess'){
	  Blockly.ParallelBlockInClipboard = true
  }
  else{
	  Blockly.ParallelBlockInClipboard = false
  }
